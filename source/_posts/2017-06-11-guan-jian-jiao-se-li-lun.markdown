...
然而有些時候，即便後果難以預測，我們還是需要為我們的疏於確認負上責任。譬如，在上一個例子中，我們增加一個條件。我有充分的時間檢查拉桿是否失靈，而且我的專業至少足以讓我在這段時間中預測出失靈的機會，譬如說，大於八成。在這種時候如果我並沒有檢查就拉下拉桿，導致機器失靈多殺死一個人時，人們反而該指責他疏於防範這個意外。
