...
為了準備演講，我幾乎讀了《露西》的每篇哲學部落文。其中，發現有兩篇交戰讓我很想要加入混戰，他們爭論的是：露西究竟有沒有問出「存有」的問題？
...
我希望你想像：你因為睡覺姿勢詭異到天怒人怨，手麻掉了，醒來，你的其他肢體部位被超自然力量懲罰綁在椅子上、眼睛忽然看不到，並失去了記憶，忘記自己是否有這隻手。此時，你無法感知到你的手，也無法移動它、使用它、回憶它。此時，**你的手依然存有，但它的存在以及對於你的存有狀態改變了**，也就是說，對你來說，它和在你面前無法感知的其他事物沒有兩樣，但**存有不會改變**。
...
Ian Chen 認為或暗示了「演化展示了存有的改變」，略加修改的話（「演化展示了存有狀態的改變」），我可以同意這句話。但這句話的成立只在露西個人身上發生，意義也不像是 Ian Chen 所說的，因為他舉的「人的存有是什麼」的問題，最後給出的答案都只是**概念**或解釋，這更接近科學家或自然哲學家的回答，但回答的都不是**存有**的問題，而是人的定義和理解的問題，是關於**存在**的問題。

雖然就理論上來說，我認為 sharon 的說法更正確些。但《露西》在我看來，確實有一個還算有趣的存有問題。這問題我不知道是不是盧貝松要問的。那就是，露西在演化的過程中，她的**存有狀態**改變了。

更嚴格地說，露西的**作為人的存有狀態**（海德格稱之為 "Dasein"，「定在」）改變了——當露西的腦力不斷發展，她與世界的共存方式便不斷改變。
