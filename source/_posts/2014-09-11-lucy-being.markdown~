...
Ian Chen 敏銳地洞見到演化與存有的關聯，但我們也能明確看到，就他將**人的存有**在不同觀點的考慮下，想成**一個**或**多個**實體的結合、想成用不同方式所理解的對象，也就是將其想成從世界中分離出來的對象而言，他所考慮的依然是**在特定狀態中的存有**，依然包含**一與多**、**客體與世界**在內的**實體**概念的形式，而也因為他考量的是存有者，才會牽涉到關於**理解**的問題。
